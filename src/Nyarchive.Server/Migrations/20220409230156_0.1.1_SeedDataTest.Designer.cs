...
namespace Nyarchive.Server.Migrations
{
    ...
    [Migration("20220409230156_0.1.1_SeedDataTest")]
    partial class _011_SeedDataTest
    {
            ...
            modelBuilder.Entity("Nyarchive.Server.Model.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f52dc481-def9-4574-abcb-451bfb0f18c6"),
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("0250677d-c42f-4426-960e-f06e434e0614"),
                            Name = "Deutsch"
                        });
                });
